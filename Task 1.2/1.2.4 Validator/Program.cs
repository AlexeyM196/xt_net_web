...
namespace _1._2._4_Validator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string base_string = "я плохо учил русский язык. забываю начинать предложения с заглавной. хорошо, что можно написать программу!";
            string[] words = base_string.Replace(". ", ".@").Replace("? ", "?@").Replace("! ", "!@").Split('@');
